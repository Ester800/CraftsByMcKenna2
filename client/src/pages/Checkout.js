...
const Checkout = ({ history }) => {
    ...
    // when we empty, we need to empty
        // 1. local storage 
        // 2. redux state
        // 3. backend
    const emptyCart = () => {
    ...
    const showApplyCoupon = () => (
        <>
            ...
            <button 
                ...
                className='btn btn-primary mt-2'>Apply Coupon</button>
        </>
    )
            ...
            <div className='col-md-6 mt-4'>
                ...
                {totalAfterDiscount > 0 && (
                        ...
                        <p className='bg-success p-2'>
                            Discount Applied: Total Due: ${totalAfterDiscount}
                        </p>
                )}
                ...
                <div className='row'>
                    ...
                    <div className="col-md-6">
                        <button 
                            disabled={!products.length} // disables the button if there are no products!
                            onClick={emptyCart} 
